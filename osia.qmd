...
- The [calendar and details for our 13 OSIA presentations](https://github.com/THOMASELOVE/500-osia-2023/blob/main/claims.md) are now available.
...
- be published since 2010 in a venue where a PDF file of the study itself and any appendix materials can be shared with the class (so journals that are available to all CWRU affiliates are preferable). Dr. Love encourages you to look for studies published after 2017.
...
- If you select an acceptable study and you are the first to "claim" it, it's yours. Once a study is claimed, Dr. Love will post it to [the OSIA claims page](https://github.com/THOMASELOVE/500-osia-2023/blob/main/claims.md). If you select a study that someone else has beaten you to, you will have to submit an alternative.

All claims must be made by the deadline posted on the [Course Calendar](calendar.qmd).

## Your Presentation

You will give a 15-minute presentation to the rest of the class summarizing the background, methods and key results of the study. 
...
For each OSIA study, everyone will read the abstracts in advance, so that we can have some understanding of what's involved and contribute to the discussion. The papers will be posted to [the Claims page](https://github.com/THOMASELOVE/500-osia-2023/blob/main/claims.md) as they are approved by Dr. Love, and the Shared Google Drive will eventually contain all of the presentations.
